---
id: tests
last_reviewed_head: e24d87816bbc
status: active
paths:
...
- Natural-language product promises should stay covered by a small-repo flow: bug orientation, failing-test orientation, branch review, and handoff checkpoint.
