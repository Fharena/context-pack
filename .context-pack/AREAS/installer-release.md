...
last_reviewed_head: 8536a751bd5d
status: active
paths:
...
- Contributor validation should expose the packaged npx smoke path through `scripts/validate_packaged_cli.py`, including natural failing-test, bug-fix, committed branch-review, soft dirty-review, Korean dirty-review, and handoff starts.
...
- Packaged validation misses natural handoff wording and leaves checkpoint cleanliness proven only by lower-level unit tests.
