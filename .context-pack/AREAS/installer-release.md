...
- Contributor validation should expose the packaged npx smoke path through `scripts/validate_packaged_cli.py`, including natural failing-test, bug-fix, committed branch-review, soft dirty-review, Korean dirty-review, long handoff, and short handoff starts.
