...
At the start of substantial work, run `context-pack status` when available, read `.context-pack/CURRENT.md` and `.context-pack/INDEX.md`, then use the relevant `.context-pack/AREAS/*.md` files before broad repo reading.
